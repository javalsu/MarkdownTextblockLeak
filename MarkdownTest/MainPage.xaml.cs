...
namespace MarkdownTest
{
    ...
    {
        public ObservableCollection<SampleTextContainer> SampleTextCollection;
        public MainPage()
        {
            this.InitializeComponent();
            SampleTextCollection = new ObservableCollection<SampleTextContainer>();
            listView.ItemsSource = SampleTextCollection;
        }

        private void LoadElements(object sender, TappedRoutedEventArgs e)
        {
            for (var i = 0; i < 10; i++)
            {
                SampleTextCollection.Add(new SampleTextContainer()
                {
        ...
        private void ClearElements(object sender, TappedRoutedEventArgs e)
        {
            SampleTextCollection.Clear();
        }

        private string GetSampleText()
        {
            return @"This control was originally written by [Quinn Damerell](https://github.com/QuinnDamerell) and [Paul Bartrum](https://github.com/paulbartrum) for [Baconit](https://github.com/QuinnDamerell/Baconit), a popular open source reddit UWP. The control *almost* supports the full markdown syntax, with a focus on super-efficient parsing and rendering. The control is efficient enough to be used in virtualizing lists.

* Note:*For a full list of markdown syntax,
                    see the[official syntax guide](http://daringfireball.net/projects/markdown/syntax).
...
";
    ...
    public class SampleTextContainer
    {
